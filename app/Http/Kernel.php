...
class Kernel extends HttpKernel
{
  ...
  protected $middlewareGroups = [
    ...
    'ticket.create' => [\App\Http\Middleware\Task\CanTaskCreate::class],
    'ticket.update.status' => [\App\Http\Middleware\Task\CanTaskUpdateStatus::class],
    'ticket.assigned' => [\App\Http\Middleware\Task\IsTaskAssigned::class],
