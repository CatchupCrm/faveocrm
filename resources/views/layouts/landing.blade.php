    ...
    <div class="row centered">
      <div class="col-lg-12">
        ...
        <h3>A <a href="https://laravel.com/">Laravel</a> {{ trans('adminlte_lang::message.laravelpackage') }}
          ...
          <a href="http://getbootstrap.com/">Bootstrap</a> 3.0 {{ trans('adminlte_lang::message.and') }} <a
            href="http://blacktie.co/demo/pratt/">Pratt</a> Landing page</h3>
      ...
      <div class="col-lg-2">
        ...
        <p>... {{ trans('adminlte_lang::message.by') }} <a href="http://acacha.org/sergitur">Sergi Tur
            ...
            href="http://acacha.org">acacha.org</a> {{ trans('adminlte_lang::message.readytouse') }}</p>
      </div>
    </div>
  </div> <!--/ .container -->
</div><!--/ #headerwrap -->
    ...
    <div class="row centered">
      ...
      <div class="col-lg-4">
        ...
        <p>{{ trans('adminlte_lang::message.see') }} <a
          ...
          <a
            href="https://github.com/acacha/adminlte-laravel/issues">{{ trans('adminlte_lang::message.issues') }}</a> {{ trans('adminlte_lang::message.and') }}
          <a
            href="https://github.com/acacha/adminlte-laravel/pulls">{{ trans('adminlte_lang::message.pullrequests') }}</a>
        </p>
      </div>
      <div class="col-lg-4">
...
<div id="c">
  <div class="container">
    <p>
      ...
      <br/>
      Pratt Landing Page {{ trans('adminlte_lang::message.createdby') }} <a
