...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      ...
      <table class="table table-bordered table-striped table_wrapper">
        <tr>
          <th>Title</th>
          <th>Time</th>
        </tr>
      ...
      <button type="button" class="btn btn-primary form-control movedown" data-toggle="modal" data-target="#invoiceModal">
        Create Invoice
      </button>
        ...
        <div class="modal-dialog" role="document">
         ...
         'url' => ['tasks/invoice', $tasks->id],
                ...
                @foreach ($contacts as $key => $contact)
                  ...
                  <br/>
                @endforeach
                {!! Form::label('mail', 'Send mail with invoice to Customer?(Checked = Yes):', ['class' => 'control-label']) !!}
